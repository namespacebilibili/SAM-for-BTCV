...
def parse_args():    
    ...
    # parser.add_argument('-sam_ckpt', default="./sam_vit_h_4b8939.pth" ,type = str, help='sam checkpoint address')
    parser.add_argument('-sam_ckpt', default="./sam_vit_b_01ec64.pth",type=str, help='sam checkpoint address')
    ...
    parser.add_argument('-multi_size',type=int,default=4,help='number of prompts')
